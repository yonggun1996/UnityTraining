...
public class EnemyFSM3 : MonoBehaviour
{
    //에너미 상태 상수
    enum EnemyState
    {
    ...
    EnemyState m_State;
    public float findDistance = 35f; // 플레이어 발견 범위
    ...
    public float moveDistance = 50f; //최대 이동가능 범위
    public int hp = 35;
    int maxHp = 35;
    ...
    void Die()
    {
        gameObject.transform.parent.GetComponent<EnemyCount3>().addkill();
        StopAllCoroutines();
